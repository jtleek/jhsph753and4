...
```{r oChunk, dependson ="onePattern",fig.height=3,fig.width=11}
...
```{r dependson ="oChunk",fig.height=3,fig.width=11}
...
```{r dependson ="oChunk",fig.height=4.5,fig.width=9}
par(mfrow=c(1,2))
...
```{r dependson ="oChunk",fig.height=4.5,fig.width=4.5}
svd1 <- svd(scale(dataMatrixOrdered))
...
```{r dependson ="oChunk",fig.height=3,fig.width=11,tidy=FALSE}
...
```{r  dependson ="twoPattern",fig.height=4,fig.width=11}
